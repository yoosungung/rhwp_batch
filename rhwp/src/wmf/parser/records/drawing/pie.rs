/// The META_PIE Record draws a pie-shaped wedge bounded by the intersection of
/// an ellipse and two radials. The pie is outlined by using the pen and filled
/// by using the brush that are defined in the playback device context.
#[derive(Clone, Debug)]
pub struct META_PIE {
    ...
    /// RecordType Enumeration table value META_PIE.
...
impl META_PIE {
    ...
    pub fn parse<R: crate::wmf::Read>(
        ...
        crate::wmf::parser::records::check_lower_byte_matches(
            record_function,
            crate::wmf::parser::RecordType::META_PIE,
        )?;
