/// The META_SETVIEWPORTORG Record defines the viewport origin in the playback
/// device context.
#[derive(Clone, Debug)]
pub struct META_SETVIEWPORTORG {
    /// RecordSize (4 bytes): A 32-bit unsigned integer that defines the number
    /// WORD structures, defined in [MS-DTYP] section 2.2.61, in the WMF
    /// record.
    pub record_size: crate::wmf::parser::RecordSize,
    /// RecordFunction (2 bytes): A 16-bit unsigned integer that defines this
    /// WMF record type. The lower byte MUST match the lower byte of the
    /// RecordType Enumeration table value META_SETVIEWPORTORG.
...
impl META_SETVIEWPORTORG {
    ...
    pub fn parse<R: crate::wmf::Read>(
        ...
        crate::wmf::parser::records::check_lower_byte_matches(
            record_function,
            crate::wmf::parser::RecordType::META_SETVIEWPORTORG,
        )?;
