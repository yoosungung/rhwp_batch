/// The META_SETWINDOWORG Record defines the output window origin in the
/// playback device context.
#[derive(Clone, Debug)]
pub struct META_SETWINDOWORG {
    ...
    /// RecordType Enumeration table value META_SETWINDOWORG.
...
impl META_SETWINDOWORG {
    ...
    pub fn parse<R: crate::wmf::Read>(
        ...
        crate::wmf::parser::records::check_lower_byte_matches(
            record_function,
            crate::wmf::parser::RecordType::META_SETWINDOWORG,
        )?;
