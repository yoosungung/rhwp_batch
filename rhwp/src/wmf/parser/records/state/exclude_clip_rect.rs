...
/// rectangle.
#[derive(Clone, Debug)]
pub struct META_EXCLUDECLIPRECT {
    ...
    /// RecordType Enumeration table value META_EXCLUDECLIPRECT.
...
impl META_EXCLUDECLIPRECT {
    ...
    pub fn parse<R: crate::wmf::Read>(
        ...
        crate::wmf::parser::records::check_lower_byte_matches(
            record_function,
            crate::wmf::parser::RecordType::META_EXCLUDECLIPRECT,
        )?;
