impl crate::wmf::parser::META_ESCAPE {
    pub(in crate::wmf::parser::records::escape) fn parse_as_CHECKPNGFORMAT<R: crate::wmf::Read>(
        buf: &mut R,
        ...
        let (png_buffer, c) = crate::wmf::parser::read_variable(buf, byte_count as usize)?;
