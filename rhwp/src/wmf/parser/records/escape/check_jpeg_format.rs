impl crate::wmf::parser::META_ESCAPE {
    pub(in crate::wmf::parser::records::escape) fn parse_as_CHECKJPEGFORMAT<R: crate::wmf::Read>(
        buf: &mut R,
        ...
        let (jpeg_buffer, c) = crate::wmf::parser::read_variable(buf, byte_count as usize)?;
