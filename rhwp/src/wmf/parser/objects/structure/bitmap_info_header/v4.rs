...
impl BitmapInfoHeaderV4 {
    ...
    pub(super) fn parse<R: crate::wmf::Read>(
        ...
        let (
            ...
            crate::wmf::parser::BitmapInfoHeaderInfo::parse(buf, header_size)?,
        ...
        let crate::wmf::parser::BitmapInfoHeaderInfo {
            header_size,
            width,
            height,
            planes,
        ...
        ) && matches!(compression, crate::wmf::parser::Compression::BI_RGB)
        {
